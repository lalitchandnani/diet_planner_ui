...
class _DietFormState extends State<DietForm> {
  ...
  Map<String, dynamic> _recommendationContent = {};
  bool _isLoading = false;
  bool _displayRecommendation = true;
  ...
  Future<void> _submitForm() async {
    ...
    if (_formKey.currentState?.validate() == true) {
      ...
      setState(() {
        ...
        _displayRecommendation = true;
        _recommendationContent = data;
      });
    } else {
      setState(() {
        _isLoading = false; // Set isLoading to false to hide the loading icon
        _displayRecommendation = false;
        _recommendationContent = {}; // Clear the data if form validation fails
      });
    }
  }
  ...
  @override
  Widget build(BuildContext context) {
    if (_displayRecommendation && _recommendationContent.isNotEmpty){
      return MaterialApp(
        ...
        home: Scaffold(
          ...
          body: Container(
                  ...
                  child: Center(child: SingleChildScrollView(
                      child: Text(
                        _recommendationContent['recommendation'],
      ...
      return MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            ...
            leading: Image.asset('images/ai_diet_planner2.png'),
          ),
          body: 
          Container(
            height: MediaQuery.of(context).size.height * 0.9,
